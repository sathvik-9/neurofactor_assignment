export default function Highlights(){
    ...
    return (
      <div className="mt-10 mb-25 bg-black text-white h-auto flex flex-col">
             ...
             {items.map((item) => (
                <div key={item.name} className="flex flex-col justify-between items-center">
                    <div className="w-full p-4 h-80 shadow-md flex items-center justify-center">    
                        <div className="max-w-4xl w-full h-full mt-5 mb-5 flex flex-col justify-between items-center bg-cover bg-center" style={{backgroundImage: `url(${item.img})`}}>
                            <p></p>
